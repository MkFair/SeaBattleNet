...
typedef void (*AlgorithArrangeShips_t)(std::vector<std::vector<char>>& field, int quantity_of_ships, int quantity_of_decks, IsNearHereAnotherShips_t IsNearHereAnotherShipsF, IsPartOfShip_t IsPartOfShipF, ShowField_t ShowFieldF);
